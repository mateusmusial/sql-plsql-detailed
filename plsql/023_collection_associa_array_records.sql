...
declare
   type t_employees_type is table of employees%rowtype index by binary_integer;

   t_employees t_employees_type;
begin
   select *
     bulk collect into t_employees -- (coleta em massa) todas as linhas para t_employees
     from employees
